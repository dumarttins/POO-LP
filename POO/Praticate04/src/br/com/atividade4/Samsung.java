...
public class Samsung extends Smartphone implements Celular{
    private double valor;

    public Samsung(boolean enviarMensagem, boolean acessarInternet, boolean email, boolean radio, boolean tv, boolean verificarSistema, double valor) {
